...
import com.viklauverk.evbt.core.edk.EDKTheory;
...
//        theory_root_dir_ = trd;
    ...
    public List<Theory> importsTheories()
    {
    ...
    public List<ProofObligation> proofObligationOrdering()
    {
    ...
    public void parse()
    {
        ...
        for (PolymorphicDataType pdt : polymorphicDataTypeOrdering())
        {
            Formula f = FormulaFactory.newPolymorphicDataTypeSymbol(
                pdt.baseName(),
                new Formula(com.viklauverk.evbt.core.sys.Node.LIST_OF_EXPRESSIONS, Formula.NO_META),
                Formula.NO_META);
