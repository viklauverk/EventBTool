...
class Formula
{
    ...
    static public Formula NO_META = null;
    ...
    public Formula(Node node, Formula meta)
    {
        node_ = node;
        meta_ = meta;
    }

    public Formula(Node node, int v, Formula meta)
    {
        node_ = node;
        data_ = new int[1];
        data_[0] = v;
    ...
    public Formula(Node node, int v, Formula inner, Formula meta)
    {
    ...
    public Formula(Node node, long v, Formula meta)
    {
        node_ = node;
        data_ = new int[2];
    ...
    public Formula(Node node, Formula inner, Formula meta)
    {
        assert (node != null && inner != null) : "Internal error when creating formula, args must be non-null.";
    ...
    public Formula(Node node, Formula left, Formula right, Formula meta)
    {
    ...
    public Formula(Node node, int v, Formula left, Formula right, Formula meta)
    {
        assert (node != null && left != null && right != null) : "Internal error when creating formula, args must be non-null.";
    ...
    public Formula(Node node, Formula vars, Formula pred, Formula expr, Formula meta)
    {
    ...
    public Formula(Node node, List<Formula> inners, Formula meta)
    {
