...
import static com.viklauverk.evbt.core.sys.NodeType.*;
...
public enum Node
{
    ...
    public boolean isPredicate() { return (bits_ & NodeType.PRE.bit) != 0; }
    public boolean isExpression() { return (bits_ & NodeType.EXP.bit) != 0; }
    public boolean isSet() { return (bits_ & NodeType.SET.bit) != 0; }
    public boolean isVariable() { return (bits_ & NodeType.VAR.bit) != 0; }
    public boolean isConstant() { return (bits_ & NodeType.CON.bit) != 0; }
    public boolean isSymbol() { return (bits_ & NodeType.SYM.bit) != 0; }
    public boolean isRelation() { return (bits_ & NodeType.REL.bit) != 0; }
    public boolean isFunction() { return (bits_ & NodeType.FUN.bit) != 0; }
    public boolean isPolymorphicDataType() { return (bits_ & NodeType.PDT.bit) != 0; }
    public boolean isConstructor() { return (bits_ & NodeType.CNS.bit) != 0; }
    public boolean isDestructor() { return (bits_ & NodeType.DES.bit) != 0; }
    public boolean isOperator() { return (bits_ & NodeType.OPE.bit) != 0; }
}
