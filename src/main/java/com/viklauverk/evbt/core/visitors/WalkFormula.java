...
public class WalkFormula implements FormulaVisitor
{
    ...
    public Formula startVisiting(Formula i)
    {
        Formula ii = innerVisit(i);
        return ii;
    }

    public Formula innerVisit(Formula ii)
    {
    ...
    public Formula visitLeft(Formula f)
    {
        return innerVisit(f.left());
    }

    public Formula visitRight(Formula f)
    {
        return innerVisit(f.right());
    }

    public Formula visitChild(Formula f)
    {
        return innerVisit(f.child());
    }

    public Formula visitChildNum(Formula f, int n)
    {
        return innerVisit(f.child(n));
    }

    public Formula visitChildren(Formula f, Runnable inbetween)
    {
