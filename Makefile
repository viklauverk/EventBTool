...
$(BUILD_MVN_BIN)/evbt: scripts/run.sh $(TEMPLATES_JAVA) $(PROJECT_DEPS)/updated.timestamp $(SOURCES) $(ANTLR_SOURCES) $(VERSION_SOURCES) $(LOGMODULES_SOURCE)
...
logmodulenames:
	@echo "// Copyright Viklauverk AB 2021-2022" > $(LOGMODULENAMES_JAVA)
...
$(TEMPLATES_JAVA):
	...
	@echo "// Copyright Viklauverk AB 2021-2022" > $(TEMPLATES_JAVA)
...
helplines:
	@echo "// Copyright Viklauverk AB 2021-2022" > $(HELPLINES_JAVA)
